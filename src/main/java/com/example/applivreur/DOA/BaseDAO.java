...
public abstract  class BaseDAO <T> {
    ...
    private String url = "jdbc:mysql://127.0.0.1:3307/Livraison";
    ...
    public abstract void update(Delivery object) throws SQLException;

    public abstract void delete(Delivery object) throws SQLException;
